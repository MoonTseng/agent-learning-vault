...
status: unread
tag: tool
takeaway: "正则引擎技术研究，与Ray兴趣关系不大，缺乏应用价值"
---

# TRE Python binding — ReDoS robustness demo

> Source: [Simon Willison](https://simonwillison.net/2026/May/4/tre-python-binding/#atom-everything)
...
<p>I had Claude Code build an experimental Python binding (i
